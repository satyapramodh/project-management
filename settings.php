	...
	<div id="data">
        ...
        <?php
			...
			$user = mysql_query("SELECT * FROM login
								WHERE id ='{$_SESSION['user_id']}' and admin={$_SESSION['admin']}");
			...
			elseif(isset($_GET['del_other_acc'])==1 && $_SESSION["admin"]==1){
				...
				//if($result["admin"]==0){
					...
					echo "<a href='settings.php?change_pass=1' >Change Password</a><br /><br />";
					//<a href='settings.php?del_acc=1' >Delete account</a>
				//}
				/*
				else{
